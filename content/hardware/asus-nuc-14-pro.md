...
date: 2026-02-12
summary: "ASUS NUC 14 Pro 搭载 Core Ultra 7 155H，是 ASUS 旗下的主力机型。"
categories: ["hardware"]
tags: ["ASUS", "MiniPC", "Core Ultra 7 155H"]
---

<div style="text-align: center; margin-bottom: 40px;">
    <h1 style="font-size: 48px; font-weight: 700; margin-bottom: 10px;">NUC 14 Pro</h1>
    <p style="color: #86868B; font-size: 20px;">ASUS // Core Ultra 7 155H</p>
</div>
...
<div class="glass-card" style="margin-bottom: 40px; text-align: left;">
    ...
    <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px;">
        <div>
            ...
            <span style="font-weight: 600;">Core Ultra 7 155H</span>
        </div>
        <div>
