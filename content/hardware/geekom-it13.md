...
title: "Geekom IT13"
date: 2026-02-12
summary: "Geekom IT13 搭载 i9-13900H，是 Geekom 旗下的主力机型。"
categories: ["hardware"]
tags: ["Geekom", "MiniPC", "i9-13900H"]
---

<div style="text-align: center; margin-bottom: 40px;">
    <h1 style="font-size: 48px; font-weight: 700; margin-bottom: 10px;">IT13</h1>
    <p style="color: #86868B; font-size: 20px;">Geekom // i9-13900H</p>
</div>
...
<div class="glass-card" style="margin-bottom: 40px; text-align: left;">
    ...
    <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px;">
        <div>
            ...
            <span style="font-weight: 600;">i9-13900H</span>
        </div>
        <div>
...
<div style="display: flex; flex-direction: column; gap: 15px;">
    ...
    <!-- KOL 测评聚合 (Bilibili) -->
    <a href="https://search.bilibili.com/all?keyword=Geekom+IT13+测评" target="_blank" class="glass-card" style="display: flex; justify-content: space-between; align-items: center; text-decoration: none; color: inherit; padding: 20px;">
        <div style="display: flex; align-items: center; gap: 15px;">
    ...
    <!-- KOL 测评聚合 (YouTube) -->
    <a href="https://www.youtube.com/results?search_query=Geekom+IT13+review" target="_blank" class="glass-card" style="display: flex; justify-content: space-between; align-items: center; text-decoration: none; color: inherit; padding: 20px;">
        <div style="display: flex; align-items: center; gap: 15px;">
